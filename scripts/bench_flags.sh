...
run_case() {
  ...
  local envs=("SQLITEJSONB_DIRECT_BUILDER=${SQLITEJSONB_DIRECT_BUILDER:-1}" \
    ...
    "SQLITEJSONB_FAST_FLOAT_DECODE=${SQLITEJSONB_FAST_FLOAT_DECODE:-0}")
